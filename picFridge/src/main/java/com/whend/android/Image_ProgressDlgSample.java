...
public class Image_ProgressDlgSample extends AsyncTask<Integer, String, Integer> {

	private ProgressDialog mDlg;
	private Context mContext;

	public Image_ProgressDlgSample(Context context) {
		mContext = context;
	}
	...
	protected Integer doInBackground(Integer... params) {
		...
		try {
			for (int i = 0; i < taskCnt; ++i) {
				...
				String path = url.toString().substring(24, url.toString().length());
