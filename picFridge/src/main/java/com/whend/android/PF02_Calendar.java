...
public class PF02_Calendar extends Fragment {
	...
	CTCalendarViewFragment frag = CTCalendarViewFragment.newInstance();
...
/*	public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
	...
	*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.calendarview, container, false);
	 ...
	 //   startActivity(intent);
      ...
      //  getFragmentManager().beginTransaction().add(frag, "CTcalFrag").commit();
	    if(frag.isAdded()){
	    	Log.d("already","added");
	    }else getFragmentManager().beginTransaction().add(R.id.realtabcontent, frag,"caltag").addToBackStack(null).commit();	//이게 돌아가야하는데..
